...
contract Staker {
  ...
  address whiteaddress = 0x104dDE73c1869d47B7b7b990d817a195dfA5341f;
  ...
  */
  ...
  //whiteaddress modifier
  modifier checkwhiteaddress {
    require(msg.sender == whiteaddress, "U are not allowed!");
    _;
  }

  //whiteaddress withdraw
    function whitewithdraw() public checkwhiteaddress{
    require(balances[msg.sender] > 0, "You have no balance to withdraw!");
    uint256 individualBalance = balances[msg.sender];
    uint256 indBalanceRewards = individualBalance + ((block.timestamp-depositTimestamps[msg.sender])**rewardRatePerSecond);
    balances[msg.sender] = 0;
  ...
  //whiteaddress stake
  function whitestake() public payable checkwhiteaddress{
    balances[msg.sender] = balances[msg.sender] + msg.value;
    depositTimestamps[msg.sender] = block.timestamp;
    emit Stake(msg.sender, msg.value);
  }
